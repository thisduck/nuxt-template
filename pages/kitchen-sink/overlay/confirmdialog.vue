...
function confirmPosition(position: string) {
  confirm.require({
    group: 'positioned',
  ...
  <div class="p-6 space-y-8">
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        ...
        <div class="flex flex-wrap justify-center gap-2 mb-4">
          <Button icon="pi pi-arrow-right" label="Left" severity="secondary" style="min-width: 10rem" @click="confirmPosition('left')" />
          <Button icon="pi pi-arrow-left" label="Right" severity="secondary" style="min-width: 10rem" @click="confirmPosition('right')" />
        </div>
        <div class="flex flex-wrap justify-center gap-2 mb-4">
          <Button icon="pi pi-arrow-down-right" label="TopLeft" severity="secondary" style="min-width: 10rem" @click="confirmPosition('topleft')" />
          <Button icon="pi pi-arrow-down" label="Top" severity="secondary" style="min-width: 10rem" @click="confirmPosition('top')" />
          <Button icon="pi pi-arrow-down-left" label="TopRight" severity="secondary" style="min-width: 10rem" @click="confirmPosition('topright')" />
        </div>
        <div class="flex flex-wrap justify-center gap-2">
          <Button icon="pi pi-arrow-up-right" label="BottomLeft" severity="secondary" style="min-width: 10rem" @click="confirmPosition('bottomleft')" />
          <Button icon="pi pi-arrow-up" label="Bottom" severity="secondary" style="min-width: 10rem" @click="confirmPosition('bottom')" />
          <Button icon="pi pi-arrow-up-left" label="BottomRight" severity="secondary" style="min-width: 10rem" @click="confirmPosition('bottomright')" />
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        ...
        <Button label="Show Template Dialog" @click="showTemplate" />
      </div>
    </div>
        ...
        <ConfirmDialog group="headless">
          <template #container="{ message, acceptCallback, rejectCallback }">
            <div class="flex flex-col items-center p-8 bg-surface-0 dark:bg-surface-900 rounded-lg shadow-lg">
              ...
              <p class="mb-0 text-center text-surface-600 dark:text-surface-300">
                {{ message.message }}
              </p>
              <div class="flex items-center gap-2 mt-6">
                <Button label="Confirm" class="w-32" @click="acceptCallback" />
                <Button label="Cancel" outlined class="w-32" @click="rejectCallback" />
              </div>
            </div>
          </template>
        </ConfirmDialog>
        <Button label="Show Headless Dialog" @click="requireConfirmation" />
      </div>
    </div>
      ...
      <div class="card">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div class="flex flex-col gap-3 p-4 border border-surface-200 dark:border-surface-700 rounded-lg">
            ...
            <Button label="Logout" severity="warning" outlined size="small" @click="confirmLogout" />
          </div>
          ...
          <div class="flex flex-col gap-3 p-4 border border-surface-200 dark:border-surface-700 rounded-lg">
            ...
            <Button label="Buy Now" severity="success" outlined size="small" @click="confirmPurchase" />
          </div>
          ...
          <div class="flex flex-col gap-3 p-4 border border-surface-200 dark:border-surface-700 rounded-lg">
            ...
            <Button label="Reset" severity="secondary" outlined size="small" @click="confirmResetSettings" />
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="space-y-4">
          ...
          <div class="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-800">
            ...
            <p class="text-red-600 dark:text-red-300 text-sm mb-3">
              Actions that cannot be undone require strong confirmation.
            </p>
            <div class="flex gap-2">
              <Button
          ...
          <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
            ...
            <p class="text-green-600 dark:text-green-300 text-sm mb-3">
              Confirmations for positive actions and achievements.
            </p>
            <div class="flex gap-2">
              <Button
                label="Publish Post"
          ...
          <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <p class="text-blue-600 dark:text-blue-300 text-sm mb-3">
              Confirmations that provide additional information.
            </p>
            <div class="flex gap-2">
              <Button
                label="Download File"
