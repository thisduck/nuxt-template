...
const tooltipValue = ref('Enter your username');
const showDelayValue = ref(1000);
const hideDelayValue = ref(300);
const customTooltip = ref('PrimeVue Rocks');

const severityOptions = ['info', 'success', 'warn', 'danger', 'secondary', 'contrast'];
</script>
  ...
  <div class="p-6 space-y-8">
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        ...
        <div class="mt-6">
          <h3 class="text-lg font-semibold text-surface-800 dark:text-surface-100 mb-3">Button Examples</h3>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        ...
        <div class="bg-surface-50 dark:bg-surface-800 p-4 rounded-lg">
          <h3 class="text-lg font-semibold text-surface-800 dark:text-surface-100 mb-3">Icon Examples</h3>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        ...
        <div class="mb-6">
          <h3 class="text-lg font-semibold text-surface-800 dark:text-surface-100 mb-3">Toolbar Example</h3>
          <Toolbar>
            <template #start>
        ...
        <!-- Form with Tooltips -->
        <div class="mb-6">
          <h3 class="text-lg font-semibold text-surface-800 dark:text-surface-100 mb-3">Form Example</h3>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="flex flex-col gap-2">
