...
<template>
  <div class="p-6 space-y-8">
    ...
    <BlockUI :blocked="documentBlocked" full-screen />
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        <div class="flex gap-2 mb-4">
          ...
          <Button label="Unblock" severity="secondary" @click="basicBlocked = false" />
        </div>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        <div class="flex gap-2 mb-4">
          <Button label="Block Document" severity="warn" @click="documentBlocked = true" />
          <Button label="Unblock Document" severity="secondary" @click="documentBlocked = false" />
        </div>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card space-y-6">
        ...
        <div>
          ...
          <Button label="Simulate Loading (3s)" :disabled="loadingBlocked" class="mb-4" @click="simulateLoading" />
        ...
        <div>
          ...
          <Button label="Simulate Progress" :disabled="progressBlocked" class="mb-4" @click="simulateProgress" />

          <BlockUI :blocked="progressBlocked">
            <template #default>
              <div class="flex flex-col items-center justify-center gap-3" style="min-height: 200px">
                <ProgressBar :value="progress" :show-value="true" style="width: 200px" />
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        <Button label="Block for 2 seconds" :disabled="autoBlocked" class="mb-4" @click="blockWithTimeout" />
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        <div class="flex gap-2 mb-4 flex-wrap">
          <Button label="Block All" size="small" @click="blockAllPanels" />
          <Button label="Unblock All" severity="secondary" size="small" @click="unblockAllPanels" />
          <Button label="Block Panel 1" severity="info" size="small" @click="multiBlocked.panel1 = !multiBlocked.panel1" />
          <Button label="Block Panel 2" severity="success" size="small" @click="multiBlocked.panel2 = !multiBlocked.panel2" />
          <Button label="Block Panel 3" severity="warn" size="small" @click="multiBlocked.panel3 = !multiBlocked.panel3" />
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <BlockUI :blocked="multiBlocked.panel1">
            <Panel header="Panel 1">
              <p class="text-sm m-0">
                First panel content that can be blocked independently.
              </p>
            </Panel>
          </BlockUI>
          ...
          <BlockUI :blocked="multiBlocked.panel2">
            <Panel header="Panel 2">
              <p class="text-sm m-0">
                Second panel content that can be blocked independently.
              </p>
            </Panel>
          </BlockUI>
          ...
          <BlockUI :blocked="multiBlocked.panel3">
            <Panel header="Panel 3">
              <p class="text-sm m-0">
                Third panel content that can be blocked independently.
              </p>
            </Panel>
          </BlockUI>
        </div>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card space-y-6">
        ...
        <div>
          ...
          <Button label="Block Image Loading" :disabled="imageBlocked" class="mb-4" size="small" @click="blockImage" />
        ...
        <div>
          ...
          <div class="flex gap-2 mb-4">
            <Button label="Block Table" size="small" @click="panelBlocked = true" />
            <Button label="Unblock Table" severity="secondary" size="small" @click="panelBlocked = false" />
          </div>
            ...
            <div class="border border-surface-200 dark:border-surface-700 rounded">
              <table class="w-full">
                <thead class="bg-surface-50 dark:bg-surface-800">
                  <tr>
                    <th class="text-left p-3 border-b border-surface-200 dark:border-surface-700">
                      Name
                    </th>
                    <th class="text-left p-3 border-b border-surface-200 dark:border-surface-700">
                      Email
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card space-y-6">
        ...
        <div>
          ...
          <div class="flex gap-2 mb-4">
            <Button label="Refresh Data" icon="pi pi-refresh" size="small" @click="blockWithTimeout" />
          </div>
        ...
        <div>
          ...
          <Button label="Upload Files" icon="pi pi-upload" :disabled="loadingBlocked" class="mb-4" size="small" @click="simulateLoading" />
        ...
        <div>
          ...
          <Button label="Save Settings" icon="pi pi-save" class="mb-4" size="small" severity="success" @click="blockWithTimeout" />
