...
<template>
  <div class="p-6 space-y-8">
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card space-y-4">
        <Message size="small" icon="pi pi-send">
          Small Message
        </Message>
        <Message icon="pi pi-user">
          Normal Message
        </Message>
        <Message size="large" icon="pi pi-check">
          Large Message
        </Message>
      </div>
    </div>
      ...
      <div class="card">
        <div class="space-y-4">
          ...
          <div class="flex flex-col gap-1">
            ...
            <Message v-if="!username" severity="error" variant="simple" size="small">
          ...
          <div class="flex flex-col gap-1">
            ...
            <Message v-if="!email" severity="error" variant="simple" size="small">
              Email is required
            </Message>
          </div>
        </div>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card space-y-4">
        ...
        <Message closable severity="success">
          Success message with close button
        </Message>
        <Message closable severity="warn">
          Warning message with close functionality
        </Message>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="card">
        <Button label="Show" :disabled="visible" class="mb-4" @click="showMessage" />
