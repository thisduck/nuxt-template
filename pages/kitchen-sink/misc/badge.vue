...
function incrementCounter(counter: string) {
  switch (counter) {
    case 'notifications':
      ...
      <div class="card space-y-6">
        ...
        <div>
          ...
          <div class="flex items-center gap-4 flex-wrap">
            ...
            <Button label="Inbox" icon="pi pi-inbox" badge="8" badge-severity="contrast" variant="outlined" />
            <Button label="Messages" icon="pi pi-envelope" badge="5" badge-severity="danger" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="flex items-center gap-4 flex-wrap">
            <Button label="Tasks" icon="pi pi-check" badge="3" badge-severity="success" severity="success" />
            <Button label="Warnings" icon="pi pi-exclamation-triangle" badge="7" badge-severity="warn" severity="warn" />
            <Button label="Errors" icon="pi pi-times" badge="12" badge-severity="danger" severity="danger" />
            <Button label="Info" icon="pi pi-info-circle" badge="4" badge-severity="info" severity="info" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="flex items-center gap-4 flex-wrap">
            ...
            <Button label="Downloads" icon="pi pi-download" badge="NEW" badge-severity="success" variant="text" />
            <Button label="Updates" icon="pi pi-refresh" badge="!" badge-severity="warn" variant="outlined" severity="secondary" />
          </div>
        </div>
      </div>
    </div>
