        ...
        <div class="flex flex-col gap-6">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="flex flex-col items-center gap-4">
              <h4 class="font-semibold text-surface-900 dark:text-surface-0">Direction: Up</h4>
            ...
            <!-- Down Direction -->
            <div class="flex flex-col items-center gap-4">
              <h4 class="font-semibold text-surface-900 dark:text-surface-0">Direction: Down</h4>
            ...
            <!-- Left Direction -->
            <div class="flex flex-col items-center gap-4">
              <h4 class="font-semibold text-surface-900 dark:text-surface-0">Direction: Left</h4>
            ...
            <!-- Right Direction -->
            <div class="flex flex-col items-center gap-4">
              <h4 class="font-semibold text-surface-900 dark:text-surface-0">Direction: Right</h4>
      ...
      <div class="bg-surface-0 dark:bg-surface-900 p-6 rounded-2xl border border-surface-200 dark:border-surface-700">
        <div class="flex flex-col gap-6">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Quarter Up-Left -->
            <div class="flex flex-col items-center gap-4">
              <h4 class="font-semibold text-surface-900 dark:text-surface-0">Direction: Up-Left</h4>
            ...
            <!-- Quarter Up-Right -->
            <div class="flex flex-col items-center gap-4">
              <h4 class="font-semibold text-surface-900 dark:text-surface-0">Direction: Up-Right</h4>
              <div class="relative h-64 w-full bg-surface-100 dark:bg-surface-800 rounded-lg">
                <SpeedDial 
                  :model="basicItems" 
                  :radius="120" 
            ...
            <!-- Quarter Down-Left -->
            <div class="flex flex-col items-center gap-4">
              <h4 class="font-semibold text-surface-900 dark:text-surface-0">Direction: Down-Left</h4>
              <div class="relative h-64 w-full bg-surface-100 dark:bg-surface-800 rounded-lg">
                <SpeedDial 
                  :model="basicItems" 
                  :radius="120" 
            ...
            <!-- Quarter Down-Right -->
            <div class="flex flex-col items-center gap-4">
              <h4 class="font-semibold text-surface-900 dark:text-surface-0">Direction: Down-Right</h4>
              <div class="relative h-64 w-full bg-surface-100 dark:bg-surface-800 rounded-lg">
                <SpeedDial 
                  :model="basicItems" 
                  :radius="120" 
            ...
            >
              ...
              <template #item="{ item, toggleCallback }">
                <div 
                  ...
                  @click="toggleCallback"
                >
                  <span :class="[item.icon, 'text-primary-500']" />
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="bg-surface-0 dark:bg-surface-900 p-6 rounded-2xl border border-surface-200 dark:border-surface-700">
        <div class="flex flex-col gap-8">
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex gap-6">
              <div class="relative h-80 w-64 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-500/10 dark:to-blue-600/10 rounded-lg border border-blue-200 dark:border-blue-500/20">
                <div class="p-4">
                  <h5 class="font-semibold text-blue-800 dark:text-blue-200">Document Actions</h5>
                  <p class="text-sm text-blue-600 dark:text-blue-300 mt-2">Manage your documents with quick actions</p>
                </div>
                <SpeedDial 
                  :model="documentItems" 
                  direction="up" 
              ...
              <div class="flex-1">
                <div v-if="apiResult" class="p-4 bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 rounded-lg mb-4">
                  <h5 class="font-semibold text-green-800 dark:text-green-200">API Response</h5>
                  <p class="text-sm text-green-700 dark:text-green-300 mt-1">{{ apiResult }}</p>
                </div>
                
                <div class="p-4 bg-surface-50 dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-lg">
                  <h5 class="font-semibold text-surface-800 dark:text-surface-200 mb-2">Action Status</h5>
          ...
          <!-- Project Management -->
          <div class="flex flex-col gap-4">
            <h4 class="font-semibold text-surface-900 dark:text-surface-0">Project Operations</h4>
            <div class="flex gap-6">
              <div class="relative h-80 w-64 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-500/10 dark:to-orange-600/10 rounded-lg border border-orange-200 dark:border-orange-500/20">
                <div class="p-4">
                  <h5 class="font-semibold text-orange-800 dark:text-orange-200">Project Tools</h5>
                  <p class="text-sm text-orange-600 dark:text-orange-300 mt-2">Deploy, build, test and backup your projects</p>
                </div>
                <SpeedDial 
                  :model="projectItems" 
                  direction="up" 
              ...
              <div class="relative h-80 w-64 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-500/10 dark:to-purple-600/10 rounded-lg border border-purple-200 dark:border-purple-500/20">
                <div class="p-4">
                  <h5 class="font-semibold text-purple-800 dark:text-purple-200">Communication</h5>
                  <p class="text-sm text-purple-600 dark:text-purple-300 mt-2">Connect with your team quickly</p>
                </div>
                <SpeedDial 
          ...
          <div v-if="actionHistory.length > 0" class="flex flex-col gap-4">
            <h4 class="font-semibold text-surface-900 dark:text-surface-0">Recent Actions</h4>
            <div class="space-y-2">
              <div 
