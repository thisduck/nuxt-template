...
const navigationItems = ref([
  {
    ...
    items: [
      ...
      { label: 'Forms', path: '/kitchen-sink/form/forms', icon: 'pi pi-file-edit' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Badge', path: '/kitchen-sink/misc/badge', icon: 'pi pi-bookmark' },
      { label: 'BlockUI', path: '/kitchen-sink/misc/blockui', icon: 'pi pi-lock' },
      { label: 'Chip', path: '/kitchen-sink/misc/chip', icon: 'pi pi-tag' },
      { label: 'Divider', path: '/kitchen-sink/misc/divider', icon: 'pi pi-minus' },
      { label: 'Inplace', path: '/kitchen-sink/misc/inplace', icon: 'pi pi-pencil' },
      { label: 'Message', path: '/kitchen-sink/misc/message', icon: 'pi pi-info-circle' },
      { label: 'MeterGroup', path: '/kitchen-sink/misc/metergroup', icon: 'pi pi-chart-bar' },
      { label: 'ProgressBar', path: '/kitchen-sink/misc/progressbar', icon: 'pi pi-spinner' },
      { label: 'ProgressSpinner', path: '/kitchen-sink/misc/progressspinner', icon: 'pi pi-spin' },
